		...
		<section className="about-section text-center" id="about">
            <div className="container px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 justify-content-center">
					...
					<img className="img-fluid" src="/ipad.png" alt="Picture of the author"></img>
            </div>
        </section>
		...
		<section className="projects-section bg-light" id="projects">
            <div className="container px-4 px-lg-5">
                ...
                <div className="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div className="col-xl-8 col-lg-7"><img className="img-fluid mb-3 mb-lg-0" src="/bg-masthead.jpg" alt="..." /></div>
                ...
                <div className="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div className="col-lg-6"><img className="img-fluid" src="/demo-image-01.jpg" alt="..." /></div>
                ...
                <div className="row gx-0 justify-content-center">
                    <div className="col-lg-6"><img className="img-fluid" src="/demo-image-02.jpg" alt="..." /></div>
